  ...
  export class AlojamentoService {
    ...
    mudarMoradorDeAlojamento(moradorId: number, alojamentoId: number): Observable<any> {
      return this.http.post(
        `http://localhost:5134/alojamentos/${alojamentoId}/mudarmorador`,
        { moradorId: moradorId } // Ajustado explicitamente
      );
  }
}
